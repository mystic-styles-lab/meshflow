...
from app.models.core import CoreStats, ConfigHistoryResponse
...
def modify_core_config(
    ...
    try:
        ...
        print(f"Failed to save config history: {e}")
...
@router.get("/core/config/history", response_model=List[ConfigHistoryResponse], responses={403: responses._403})
def get_config_history(
    ...
    return db.query(ConfigHistory).order_by(ConfigHistory.created_at.desc()).offset(offset).limit(limit).all()
