      ...
      {tabIndex == 0 && (
        ...
        >
          ...
          <Box
            ...
            px={3}
            py={1}
            bg={custom ? "primary.500" : "rgba(255, 255, 255, 0.05)"}
            color={custom ? "white" : "unset"}
            boxShadow={custom ? "0 0 10px rgba(99, 102, 241, 0.3)" : "none"}
            transition="all 0.2s"
            _hover={{
              bg: custom ? "primary.500" : "rgba(255, 255, 255, 0.1)",
            }}
            _light={{
              bg: custom ? "primary.500" : "rgba(255, 255, 255, 0.5)",
              _hover: {
                bg: custom ? "primary.500" : "rgba(255, 255, 255, 0.7)",
              },
            }}
